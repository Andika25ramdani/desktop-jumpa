	...
	<div id="contactDetails" class="overlay-bg fixed top-0 left-0 h-screen w-screen z-50 flex flex-col items-center justify-center">
		<transition name="slide-down" appear>
            <div class="bg-white rounded-px5 mx-auto border border-grey-lighter flex flex-col items-center py-px15 lg:py-4 xl:py-5 2xl:py-6 max-w-xs">
                ...
                <div class="px-8 text-center py-px15 lg:py-4 xl:py-5 2xl:py-6">
                ...
                <div class="flex justify-center gap-2.5 items-center border-t border-grey-lighter pt-2.5 lg:pt-3 xl:pt-4 2xl:pt-5 w-full">
                    <button @click="$emit('edit')" class="bg-grey-background border border-grey-lighter text-px10 text-grey-ed rounded-px5 px-4 lg:px-5 xl:px-6 2xl:px-7 py-px5 lg:py-2">Edit Contact</button>
                    <button @click="$emit('delete')" class="bg-red text-white text-px10 rounded-px5 px-4 lg:px-5 xl:px-6 2xl:px-7 py-px5 lg:py-2">Delete</button>
                </div>
            </div>
		</transition>
	</div>
