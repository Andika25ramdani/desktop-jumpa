            ...
            <div class="bg-white rounded-px5 mx-auto border border-grey-lighter flex flex-col items-center">
                <form @submit.prevent="contactEdit" class="mt-4 lg:mt-5 xl:mt-6 2xl:mt-7 flex-1 flex flex-col items-center">
                    ...
                    <div class="border-t border-grey-lighter py-2.5 w-full mt-4 lg:mt-5 xl:mt-6 2xl:mt-7 flex items-center">
                        <button type="submit" @click="contactEdit" class="bg-green rounded-px5 px-4 lg:px-5 xl:px-6 2xl:px-7 py-px5 lg:py-2 text-px10 text-white mx-auto">Save Contact</button>
                    </div>
                </form>
            </div>
		</transition>
