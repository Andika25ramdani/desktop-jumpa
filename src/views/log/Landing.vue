<template>
  <div class="landing">
    <figure class="logo-figure rounded-full">
      <img src="img/icons/jumpa-logo.png" alt="Logo Jumpa">
    </figure>
    <h1 class="font-bold text-center text-2xl text-white mt-4 mb-10">jumpa.id</h1>
