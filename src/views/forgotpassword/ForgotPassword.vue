<template>
	<div id="forgotPassword">
		<div class="flex flex-col items-center bg-white rounded-px5 p-px30 shadow-custom xl:p-10">
			<h2 class="font-bold text-grey-dark text-2xl xl:text-3xl text-center mb-2.5">Forgot Password?</h2>
            <img src="img/forgot-password.png" alt="" class="mx-auto py-px30">
            <p class="text-xs xl:text-sm text-grey-dark text-center mb-2.5 font-bold">Enter the email address<br>associated with your account</p>
            <p class="text-xs xl:text-sm text-grey-dark text-center mb-px30">we will email you a link to reset your password</p>
