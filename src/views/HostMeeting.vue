	...
	<div class="join-meeting">
        ...
        ">
			<h2 class="
				...
				2xl:text-2 2xl:mb-8
            ">Host Meeting</h2>
			<form @submit.prevent="hostMeeting" class="
            ...
            ">
				...
				<div class="flex flex-col gap">
					<input type="text" v-model="hostCode" placeholder="Enter the Host Code" class="border border-grey-ce rounded-px5 red-input outline-none">
