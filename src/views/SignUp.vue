<template>
	<div class="sign-up">
		<div class="bg-white rounded-px5 p-px25 shadow-custom">
			...
			<form @submit.prevent="signUp" class="flex flex-col gap-2.5">
				...
				<button type="submit" class="submit-form mt-5 bg-primary text-xs font-bold uppercase py-2 px-px94 text-white rounded-px5 hover:shadow-custom">SIGN UP</button>
			</form>
